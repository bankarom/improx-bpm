...
const MOCK_INDUSTRIES: IndustryData[] = [
  { 
    ...
    secondaryImage: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80',
    overview: 'In the heavily regulated BFSI sector, manual processing errors do not just cost moneyΓÇöthey invite massive regulatory fines. We engineer bulletproof, compliant back-office operations for global banks and insurers.',
    challenges: [
  ...
  { 
    ...
    businessImpact: [
      ...
      { title: 'Engineer Focus', description: 'Protect your engineering teamΓÇÖs time by deflecting 80% of incoming tickets.' },
...
const MOCK_POSTS = [
  ...
  },
  {
    ...
    content: `In 2026, leading with Average Handle Time (AHT) as your primary support KPI is a guaranteed path to poor customer satisfaction.\n\n### The 5 Metrics That Actually Matter\n\n**1. First Contact Resolution (FCR)** ΓÇö the single strongest predictor of customer satisfaction.\n**2. Customer Satisfaction Score (CSAT)** ΓÇö measured immediately post-interaction.\n**3. Customer Effort Score (CES)** ΓÇö lower effort means higher loyalty.\n**4. Net Promoter Score (NPS)** ΓÇö reveals the long-term health of customer relationships.\n**5. Escalation Rate** ΓÇö reveals training gaps and process failures in real-time.`
  },
  {
  ...
  },
  {
    ...
    excerpt: "Poor data quality costs the US economy $3.1 trillion per year. Here is how to calculate your organization's data quality debt ΓÇö and fix it.",
    date: 'July 25, 2026',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    content: `Data governance programs fail for one primary reason: they are treated as IT projects rather than business programs.\n\n### The 4 Pillars of Effective Data Governance\n\n**1. Data Ownership** ΓÇö every data entity must have a designated business owner.\n**2. Data Standards** ΓÇö clear definitions enforced at the point of entry.\n**3. Data Quality Monitoring** ΓÇö automated dashboards measuring KPIs in real-time.\n**4. Continuous Remediation** ΓÇö a standing process addressing quality issues before they compound.`
  },
  {
